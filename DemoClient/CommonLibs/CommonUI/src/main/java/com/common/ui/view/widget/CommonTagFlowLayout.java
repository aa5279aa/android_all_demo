...
public class CommonTagFlowLayout extends FlowLayout
    ...
    public CommonTagFlowLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public CommonTagFlowLayout(Context context, AttributeSet attrs) {
